...
// --- Rekap Nilai --- //
$routes->get('/rn-option-kelas', 'CRekapNilaiMapel::option_kelas');
$routes->get('/rn-option-tahun', 'CRekapNilaiMapel::option_tahun');
$routes->post('/data-nilai-mapel', 'CRekapNilaiMapel::data_siswa');
